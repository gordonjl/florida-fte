...
export default function Header() {
    return (<nav className="flex flex-col space-y-6 sm:w-full mt-6 text-nav-black">
        <section className="flex flex-col space-y-6 sm:space-y-0 sm:flex-row sm:justify-between border-b-2 pb-8">
            <img src="/SunPassLogo-Blue.svg" className="sm:ml-14 w-1/2 self-center sm:self-center sm:w-44 sm:flex-none " />

            <ul className="flex space-x-5 min-w-min sm:whitespace-nowrap text-lg  w-max flex-grow-2 justify-end items-end ml-3 mr-12  pb-3">
            ...
            <section className="flex flex-col space-y-5 mr-5">
                ...
                <div className="flex space-x-8 ">
                    <FteButton label="My SunPass" color="primary" ></FteButton>
